...
console.log(`Valor de emAberto (inteiro): ${emAberto}`);

emAberto = parseFloat(a) + parseFloat(b);
console.log(`Valor de emAberto (real): ${emAberto}`);

let npf = "30.45";
let pontoFlutuante = parseFloat(npf);
console.log(`Valor de pontoFlutuante: ${pontoFlutuante}`);